            ...
            <Link href="/" className="flex items-center gap-3 group">
                ...
                <div className="w-10 h-10 rounded-full bg-black dark:bg-white flex items-center justify-center overflow-hidden border border-white/10 dark:border-black/10 shrink-0 group-hover:scale-105 transition-transform duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] dark:shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                    <div className="grid grid-cols-2 grid-rows-2 w-full h-full p-1 gap-0">
                        <div className="flex items-center justify-center text-white dark:text-black font-mono font-bold text-xs leading-none">R</div>
                        ...
                        <div className="flex items-center justify-center">
                            <Image
                                ...
                                width={14}
                                height={14}
                                className="object-contain opacity-50 dark:opacity-100 dark:invert group-hover:opacity-100 dark:group-hover:opacity-100 transition-opacity duration-300"
                            />
                        </div>
                    </div>
                </div>

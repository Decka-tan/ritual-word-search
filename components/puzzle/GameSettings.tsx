        ...
        <div className="relative">
            ...
            {isOpen && (
                <>
                    ...
                    {/* Settings Panel */}
                    <div className="absolute top-full left-4 right-4 sm:left-auto sm:right-0 sm:w-80 mt-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-2xl z-50 p-5 max-h-[80vh] overflow-y-auto">

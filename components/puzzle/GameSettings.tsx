        ...
        <div className="relative">
            ...
            {isOpen && (
                <>
                    ...
                    {/* Settings Panel */}
                    <div className="absolute top-full left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 mt-2 w-[calc(100%-2rem)] sm:w-80 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-2xl z-50 p-5 max-h-[80vh] overflow-y-auto">

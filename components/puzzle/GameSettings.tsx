        ...
        <div className="relative">
            ...
            {isOpen && (
                <>
                    ...
                    {/* Settings Panel */}
                    <div className="absolute top-full right-0 left-0 sm:left-auto mt-2 w-[calc(100%-2rem)] mx-4 sm:mx-0 sm:w-80 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-2xl z-50 p-5 max-h-[80vh] overflow-y-auto">
